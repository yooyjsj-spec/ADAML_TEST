...
// NOTE: 개별 저널 이미지가 있다면 "/images/journals/파일이름.png" 형태로 image 필드를 수정하세요.
// 이미지가 없으면 빈 문자열("")이나 ASSETS.JOURNALS.DEFAULT_COVER를 사용할 수 있습니다.

export const journalData: JournalPaper[] = [
  {
  ...
  // (나머지 데이터들도 image 경로를 /images/journals/... 형태로 수정하거나, ASSETS.JOURNALS.DEFAULT_COVER를 사용할 수 있습니다)
];
